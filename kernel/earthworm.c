...
#include <linux/list.h>        		/* Linked list implementation list */
...
//static void * __find_sys_call_table(void);
#endif
...
/* obsolete 
static void * 
__deprecated find_sys_call_table(void)
{
        struct {
        ...
        unsigned long system_call = 0;        // x80ä¸­æ­å¤çç¨åºsystem_call å°å
        char *call_hex = "\xff\x14\x85";        // call æä»¤
        char *code_ptr = NULL;
        char *p = NULL;
